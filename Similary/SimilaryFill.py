...
def load_data(url):
    ...
    for i in range(len(dateListResult)):
        ...
        #print('相似日期为：',sortedDistance[0][0],sortedDistance[1][0],sortedDistance[2][0],
                             #sortedDistance[3][0],sortedDistance[4][0])
        #simi[dateListResult[i]] = [sortedDistance[0][0], sortedDistance[1][0], sortedDistance[2][0],sortedDistance[3][0], sortedDistance[4][0]]
...
if __name__=='__main__':
    ...
    for file in os.listdir('../datasets/power'):
        ...
        print(id)
        if id <= 151:
            load_data(os.path.join('../datasets/power',file))